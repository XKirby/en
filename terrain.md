...
> > *Pros*{: .header-font .fs-5 }
> >
> > Grounded characters making *Trickery*{: .spirit-color } checks to dodge incoming attacks receive +[X]d6, as if Boosted, and successfully dodging a melee attack (without Reach) causes the attacker to take ½ [X] damage from the spikes.
> >
>
> {: .terrain-cons-callout }
> > *Cons*{: .header-font .fs-5 }
